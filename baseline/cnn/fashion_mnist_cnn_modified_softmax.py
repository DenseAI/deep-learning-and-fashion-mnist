...
from layers import ModifiedSoftmaxLayer
# Seed value
...
checkpoint_path = './weights/modified_softmax_weight.ckpt'
...
plt.grid(True)
plt.savefig('./images/cnn_modified_softmax_acc.png')
plt.show()
...
plt.legend(['Train', 'Validation'], loc='upper left')
plt.grid(True)
plt.savefig('./images/cnn_modified_softmax_loss.png')
plt.show()
...
def plot_confusion_matrix(y_true, y_pred, classes,
    ...
    fig.tight_layout();
    plt.savefig('./images/cnn_modified_softmax_confusion_matrix.png')
