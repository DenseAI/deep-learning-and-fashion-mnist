...
def create_model():
    ...
    output = SphereFace(10, m=4, regularizer=regularizers.l2(weight_decay))([x, input_label])
...
checkpoint_path = 'cp-weights.ckpt'
...
plt.grid(True)
plt.savefig('./images/softmax_acc.png')
plt.show()
...
plt.legend(['Train', 'Validation'], loc='upper left')
plt.grid(True)
plt.savefig('./images/softmax_loss.png')
plt.show()
...
def plot_confusion_matrix(y_true, y_pred, classes,
	...
	fig.tight_layout();
	plt.savefig('./images/softmax_confusion_matrix.png')
	#return ax
